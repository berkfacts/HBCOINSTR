...
<head>
  ...
  <title>EA FC 24 Coins Sat &amp; Sell EA FC 24 Coins - HBCOINSTR EAFC 24 Coins</title>
  ...
  <link rel="stylesheet" href="coinsat.css">
...
<body>
  <nav>
   ...
   <option value="du">🇳🇱 <?php echo $lang['Flemenkçe']; ?></option>
    ...
    <ul class="nav-links">
      ...
      <li><a href="coinsat.php" class="active"><?php echo $lang['fifa coins sat']; ?></a></li>
  ...
  <div class="order-section">
    <h2 class="order-title"><?php echo $lang['EAFC 24 Coins Sat']; ?></h2>
    <p class="order-description"><?php echo $lang['Elinizdeki EAFC 24 Coinslerinizi nakit paraya çevirmek için aşağıdaki sosyal medya hesaplarımıza yazabilirsiniz.']; ?></p>
    <div class="order-buttons">
      <a href="https://www.instagram.com/hbcoinstr/" class="order-button">
        <img src="img/instagram.png" alt="instagram"><?php echo $lang['İNSTAGRAM İLE SAT']; ?> </a>
      <a href="https://twitter.com/hbcoinstr43869" class="order-button">
        <img src="img/twitter.png" alt="twitter"><?php echo $lang['TWİTTER İLE SAT']; ?></a>
      <a href="https://wa.me/905446651866?text=Coins satmak istiyorum" class="order-button">
        <img src="img/whatsapp.png" alt="whatsapp"><?php echo $lang['WHATSAPP İLE SAT']; ?></a>
    </div>
  </div>
  ...
  <!-----------------------whatsapp---------------------------------------------->
   <div class="whatsapp-icon">
    <a href="https://wa.me/905446651866?text=Coins satmak istiyorum" title="whatsapp'a gider"
    class="whatsapp-link">
